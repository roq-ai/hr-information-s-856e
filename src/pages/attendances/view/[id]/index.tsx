...
import { useAttendanceFindFirst, useRoqClient } from 'lib/roq';
...
function AttendanceViewPage() {
  ...
  const { data, error, isLoading } = useAttendanceFindFirst(queryParams, {}, { disabled: !id });
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Check In" text={data?.check_in ? format(data?.check_in, 'dd-MM-yyyy') : ''} />

                <FormListItem label="Check Out" text={data?.check_out ? format(data?.check_out, 'dd-MM-yyyy') : ''} />
