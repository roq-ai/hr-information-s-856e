...
export function useEmployeeDataFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useEmployeeDataFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.employee_data.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useEmployeeDataCount<T extends Prisma.employee_dataCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.employee_dataCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useEmployeeDataCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.employee_data.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useEmployeeDataFindManyWithCount<
  T extends Prisma.employee_dataFindManyArgs,
  R extends { data: GetFindResult<Prisma.$employee_dataPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.employee_dataFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useEmployeeDataFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.employee_data.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useEmployeeDataFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useEmployeeDataFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.employee_data.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
