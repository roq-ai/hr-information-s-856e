...
import type { Prisma, attendance, company, employee_data, payroll, user, vacation } from './types';
...
interface AttendanceSDK {
  create: <
    ...
    U extends Omit<Prisma.attendanceCreateArgs, 'data'> & {
  ...
  update: <
    ...
    U extends Omit<Prisma.attendanceUpdateArgs, 'data'> & {
...
interface UserSDK {
  create: <
    ...
    U extends Omit<Prisma.userCreateArgs, 'data'> & {
      data: Omit<Prisma.userUncheckedCreateInput, 'attendance' | 'employee_data' | 'payroll' | 'vacation'>;
    },
  >(
    data: Prisma.SelectSubset<U, T>,
    options?: RequestOptions,
  ...
  update: <
    ...
    U extends Omit<Prisma.userUpdateArgs, 'data'> & {
      data: Omit<Prisma.userUncheckedUpdateInput, 'attendance' | 'employee_data' | 'payroll' | 'vacation'>;
    },
  >(
    data: Prisma.SelectSubset<U, T>,
    options?: RequestOptions,
